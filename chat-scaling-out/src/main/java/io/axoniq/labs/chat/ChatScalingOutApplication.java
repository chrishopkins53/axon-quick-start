...
public class ChatScalingOutApplication {
    ...
    public static class AmqpConfiguration {
	    ...
	    @Bean
        public Exchange eventsExchange() { return ExchangeBuilder.fanoutExchange("events").build();}

        @Bean
        public Queue participantsEventsQueue() { return QueueBuilder.durable("events").build();}
